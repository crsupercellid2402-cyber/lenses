                ...
                <template x-if="$store.breakpoints.smAndUp">
                    ...
                    >
                        {{-- <div class="relative mr-4 flex h-8">
                            <input
                                placeholder="Искать..."
                                class="form-input peer h-full rounded-full ml-[120px] bg-slate-150 px-4 pl-9 text-xs-plus text-slate-800 ring-primary/50 hover:bg-slate-200 focus:ring-3 dark:bg-navy-900/90 dark:text-navy-100 dark:placeholder-navy-300 dark:ring-accent/50 dark:hover:bg-navy-900 dark:focus:bg-navy-900"
...
{{--                                        <img--}}
{{--                                            class="mx-auto w-36"--}}
{{--                                            src="{{ asset('vendor/images/illustrations/empty-girl-box.svg') }}"--}}
{{--                                            alt="image"--}}
{{--                                        />--}}
{{--                                        <div class="mt-5">--}}
{{--                                            <p--}}
